# Generated by Django 3.2.3 on 2021-05-17 07:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveBigIntegerField(choices=[(0, '删除'), (1, '正常')], default=0, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveBigIntegerField(choices=[(0, '删除'), (1, '正常'), (2, '草稿')], default=0, verbose_name='状态')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='作者')),
